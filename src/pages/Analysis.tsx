...
export default function Analysis({ className }: Props) {
  ...
  return (
    <div className={`animate-fade-in ${className || ''}`}>
      {/* 头部筛选 */}
      <div className="bg-white border style={{borderColor: 'var(--border)'}} rounded-[13px] style={{boxShadow: 'var(--shadow)'}} overflow-hidden mt-8">
      ...
      {activeTab === 'expense' ? (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          ...
          <div className="bg-white border style={{borderColor: 'var(--border)'}} rounded-[13px] style={{boxShadow: 'var(--shadow)'}} p-8">
            ...
            {categoryStats.length > 0 ? (
              ...
              <div className="h-[300px] flex items-center justify-center style={{color: 'var(--text-muted)'}} empty-state">
                当月暂无支出记录
              </div>
            )}
          </div>
          ...
          <div className="bg-white border style={{borderColor: 'var(--border)'}} rounded-[13px] style={{boxShadow: 'var(--shadow)'}} p-8">
            <div className="flex items-center gap-2 mb-6">
              <TrendingUp size={24} className="style={{color: 'var(--primary)'}} icon-bounce-hover" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          ...
          <div className="bg-white border style={{borderColor: 'var(--border)'}} rounded-[13px] style={{boxShadow: 'var(--shadow)'}} p-8">
            <div className="flex items-center gap-2 mb-6">
              <PieChart size={24} className="style={{color: 'var(--primary)'}} icon-spin-hover" />
          ...
          <div className="space-y-5">
            <div className="bg-white border style={{borderColor: 'var(--border)'}} rounded-[13px] style={{boxShadow: 'var(--shadow)'}} p-8">
              <div className="flex items-center gap-2 mb-4">
                <Wallet size={20} className="style={{color: 'var(--success)'}} icon-scale-hover" />
                ...
                {assetAllocation.map(item => (
                  <div key={item.type} className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-sm font-medium style={{color: 'var(--text)'}} number">¥{item.amount.toLocaleString()}</div>
                      <div className="text-xs style={{color: 'var(--text-muted)'}}">{item.percentage.toFixed(1)}%</div>
                    </div>
                  </div>
                ))}
                {assetAllocation.length === 0 && (
                  <div className="text-center py-8 style={{color: 'var(--text-muted)'}} empty-state">
                    暂无资产数据
                  </div>
                )}
              </div>
           ...
           {/* 资产配置建议模块 */}
           <div className="mt-6 bg-white border style={{borderColor: 'var(--border)'}} rounded-[13px] style={{boxShadow: 'var(--shadow)'}} p-8">
             <div className="flex items-center gap-2 mb-6">
               <Target size={24} className="style={{color: 'var(--primary)'}} icon-spin-hover" />
             ...
             {!riskResult ? (
               <div className="text-center py-12 bg-yellow-50 border border-yellow-100 rounded-lg">
                 ...
                 <button 
                   ...
                   className="px-4 py-2 style={{backgroundColor: 'var(--primary)'}} text-white rounded-lg hover:bg-opacity-90 transition-all"
                 >
                   去完成风险测评
                 </button>
               </div>
             ) : assetAllocation.length === 0 ? (
               <div className="text-center py-12 style={{color: 'var(--text-muted)'}} empty-state">
               ...
               <div className="space-y-6">
                   ...
                   <table className="w-full border-collapse">
                     ...
                     <tbody>
                       {Object.entries(recommendedAllocation).map(([assetClass, targetPercent]) => {
                         ...
                         return (
                           <tr key={assetClass} className="border-b style={{borderColor: 'var(--border)'}} last:border-b-0">
                 ...
                 {/* 调仓建议 */}
                 <div className="p-4 style={{backgroundColor: 'var(--bg-soft)'}} border style={{borderColor: 'var(--border)'}} rounded-lg">
                   <h4 className="font-medium mb-3 flex items-center gap-2 style={{color: 'var(--text)'}}">
                     <AlertCircle size={18} className="style={{color: 'var(--primary)'}}" />
                     调仓建议
                   </h4>
                   <ul className="space-y-2">
                     {allocationSuggestions.map((suggestion, index) => (
                       <li key={index} className="text-sm flex items-start gap-2 style={{color: 'var(--text)'}}">
                         <CheckCircle size={16} className="mt-0.5 style={{color: 'var(--primary)'}} flex-shrink-0" />
        ...
        <div className="mt-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white border style={{borderColor: 'var(--border)'}} rounded-[14px] style={{boxShadow: 'var(--shadow)'}} p-8 relative overflow-hidden">
              <div className="text-center">
                <div className="text-lg font-extrabold style={{color: 'var(--text-muted)'}} mb-4">财务健康指数</div>
            ...
            {/* 维度得分卡片 */}
            <div className="md:col-span-2 bg-white border style={{borderColor: 'var(--border)'}} rounded-[14px] style={{boxShadow: 'var(--shadow)'}} p-8">
              <h3 className="text-xl font-extrabold style={{color: 'var(--text)'}} mb-6">各维度得分</h3>
              <div className="space-y-5">
          ...
          {/* 优化建议 */}
          <div className="mt-6 bg-white border style={{borderColor: 'var(--border)'}} rounded-[14px] style={{boxShadow: 'var(--shadow)'}} p-8">
            <div className="flex items-center gap-2 mb-6">
              <AlertCircle size={24} className="style={{color: 'var(--primary)'}}" />
              ...
              <ul className="space-y-3">
                {healthScore.suggestions.map((suggestion, index) => (
                  <li key={index} className="flex items-start gap-3 p-3 bg-blue-50 border border-blue-100 rounded-lg">
                    <CheckCircle size={20} className="style={{color: 'var(--primary)'}} flex-shrink-0 mt-0.5" />
       ...
       {activeTab === 'expense' && (
         <>
           <div className="bg-white border style={{borderColor: 'var(--border)'}} rounded-[13px] style={{boxShadow: 'var(--shadow)'}} p-8 mt-6">
             <div className="flex items-center gap-2 mb-6">
                 <FileText size={24} className="style={{color: 'var(--warning)'}} icon-scale-hover" />
             ...
             <div className="space-y-4">
               <div className="style={{backgroundColor: 'var(--bg-soft)'}} border style={{borderColor: 'var(--border)'}} rounded-sm p-4">
               ...
               <div className="bg-blue-50 border border-blue-100 rounded-sm p-4">
                 <h4 className="font-medium mb-2 flex items-center gap-2 style={{color: 'var(--text)'}}">
                   <AlertCircle size={16} className="style={{color: 'var(--primary)'}}" />
                   消费建议
                 </h4>
                 <ul className="space-y-2">
               ...
               return (
                 <div className="space-y-6">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                     <div className="style={{backgroundColor: 'var(--bg-soft)'}} border style={{borderColor: 'var(--border)'}} rounded-sm p-5">
