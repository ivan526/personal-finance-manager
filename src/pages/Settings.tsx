  ...
  return (
    <div className={`animate-fade-in ${className || ''}`}>
      ...
      <div className="bg-white border style={{borderColor: 'var(--border)'}} rounded-[13px] style={{boxShadow: 'var(--shadow)'}} p-8 mt-8">
        <h3 className="text-xl font-extrabold style={{color: 'var(--text)'}} mb-6">数据管理</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-5">
          <div className="p-6 border style={{borderColor: 'var(--border)'}} rounded-[14px] hover:border-blue-300 hover:bg-blue-50 transition-all cursor-pointer hover:style={{boxShadow: 'var(--shadow)'}}" onClick={handleExport}>
            <div className="w-[66px] h-[66px] rounded-[14px] bg-gradient-to-br from-blue-50 to-blue-100 style={{color: 'var(--primary)'}} flex items-center justify-center mb-4">
              <Download size={32} />
            </div>
          ...
          <label className="p-6 border style={{borderColor: 'var(--border)'}} rounded-[14px] hover:border-green-300 hover:bg-green-50 transition-all cursor-pointer hover:style={{boxShadow: 'var(--shadow)'}}">
            <div className="w-[66px] h-[66px] rounded-[14px] bg-gradient-to-br from-green-50 to-green-100 style={{color: 'var(--success)'}} flex items-center justify-center mb-4">
              <Upload size={32} />
            </div>
          ...
          <div className="p-6 border style={{borderColor: 'var(--border)'}} rounded-[14px] hover:border-cyan-300 hover:bg-cyan-50 transition-all cursor-pointer hover:style={{boxShadow: 'var(--shadow)'}}" onClick={() => setShowImportModal(true)}>
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
           <div className="p-6 border style={{borderColor: 'var(--border)'}} rounded-[14px] hover:border-purple-300 hover:bg-purple-50 transition-all cursor-pointer hover:style={{boxShadow: 'var(--shadow)'}}" onClick={exportTransactionCSV}>
           ...
           <div className="p-6 border style={{borderColor: 'var(--border)'}} rounded-[14px] hover:border-amber-300 hover:bg-amber-50 transition-all cursor-pointer hover:style={{boxShadow: 'var(--shadow)'}}" onClick={exportBalanceSheetCSV}>
             <div className="w-[66px] h-[66px] rounded-[14px] bg-gradient-to-br from-amber-50 to-amber-100 style={{color: 'var(--warning)'}} flex items-center justify-center mb-4">
               <PieChart size={32} />
             </div>
           ...
           <div className="p-6 border style={{borderColor: 'var(--border)'}} rounded-[14px] hover:border-red-300 hover:bg-red-50 transition-all cursor-pointer hover:style={{boxShadow: 'var(--shadow)'}}" onClick={handleClear}>
             <div className="w-[66px] h-[66px] rounded-[14px] bg-gradient-to-br from-red-50 to-red-100 style={{color: 'var(--danger)'}} flex items-center justify-center mb-4">
               <Trash2 size={32} />
             </div>
           ...
           <div className="p-6 border style={{borderColor: 'var(--border)'}} rounded-[14px] hover:border-indigo-300 hover:bg-indigo-50 transition-all cursor-pointer hover:style={{boxShadow: 'var(--shadow)'}}" onClick={() => setShowEncryptExportModal(true)}>
           ...
           <label className="p-6 border style={{borderColor: 'var(--border)'}} rounded-[14px] hover:border-teal-300 hover:bg-teal-50 transition-all cursor-pointer hover:style={{boxShadow: 'var(--shadow)'}}">
      ...
      <div className="bg-white border style={{borderColor: 'var(--border)'}} rounded-[13px] style={{boxShadow: 'var(--shadow)'}} p-8 mt-6">
        <h3 className="text-xl font-extrabold style={{color: 'var(--text)'}} mb-6">外观设置</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button
            ...
            className={`p-4 border rounded-[14px] transition-all flex flex-col items-center gap-3 hover:border-blue-300 hover:bg-blue-50/50 ${
              theme === 'light' ? 'border-blue-500 bg-blue-50 ring-2 ring-blue-200' : 'style={{borderColor: 'var(--border)'}}'
            }`}
          >
          ...
          <button
            ...
            className={`p-4 border rounded-[14px] transition-all flex flex-col items-center gap-3 hover:border-blue-300 hover:bg-blue-50/50 ${
              theme === 'dark' ? 'border-blue-500 bg-blue-50 ring-2 ring-blue-200' : 'style={{borderColor: 'var(--border)'}}'
            }`}
          >
          ...
          <button
            ...
            className={`p-4 border rounded-[14px] transition-all flex flex-col items-center gap-3 hover:border-blue-300 hover:bg-blue-50/50 ${
              theme === 'system' ? 'border-blue-500 bg-blue-50 ring-2 ring-blue-200' : 'style={{borderColor: 'var(--border)'}}'
            }`}
          >
       ...
       <div className="bg-white border style={{borderColor: 'var(--border)'}} rounded-[13px] style={{boxShadow: 'var(--shadow)'}} p-8 mt-6">
         <div className="flex items-center justify-between mb-6">
           <div>
             ...
             <p className="text-sm style={{color: 'var(--text-muted)'}} mt-1">管理家庭成员，支持多成员收支统计和资产合并查看</p>
           </div>
           <button
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
           {familyMembers.map(member => (
             <div key={member.id} className="p-4 border style={{borderColor: 'var(--border)'}} rounded-[14px] hover:border-blue-300 transition-all">
       ...
       <div className="bg-white border style={{borderColor: 'var(--border)'}} rounded-[13px] style={{boxShadow: 'var(--shadow)'}} p-8 mt-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm style={{color: 'var(--text-muted)'}} mt-1">评估您的风险等级，获取个性化资产配置建议</p>
          </div>
          {!riskResult ? (
            <button
            ...
            >
              ...
              <button
                onClick={() => setShowRiskAssessment(true)}
                className="ml-4 text-sm underline hover:style={{color: 'var(--primary)'}}"
              >
                重新测评
              </button>
            </div>
        ...
        {riskResult && (
          <div className="style={{backgroundColor: 'var(--bg-soft)'}} border style={{borderColor: 'var(--border)'}} rounded-lg p-4">
            <div className="flex items-start gap-3">
              <div 
              ...
              <div>
                <h4 className="font-semibold text-lg style={{color: 'var(--text)'}} mb-1">{riskResult.level}投资者</h4>
      ...
      <div className="bg-white border style={{borderColor: 'var(--border)'}} rounded-[13px] style={{boxShadow: 'var(--shadow)'}} p-8 mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {/* 支出分类 */}
          <div>
            <h4 className="font-semibold text-lg mb-4 style={{color: 'var(--text)'}} flex items-center gap-2">
            ...
            <div className="space-y-2">
              {categories.filter(c => c.type === 'expense').map(category => (
                <div 
                  key={category.id} 
                  className="flex items-center justify-between p-3 border style={{borderColor: 'var(--border)'}} rounded-lg hover:border-blue-200 transition-all"
                >
                  <div className="flex items-center gap-3">
                    <div 
                  ...
                  {category.isCustom && (
                    <div className="flex gap-1">
                      <button
                        ...
                        className="w-8 h-8 flex items-center justify-center style={{color: 'var(--primary)'}} hover:bg-blue-50 rounded transition-all"
                      >
                        <Edit2 size={16} />
                      </button>
                      <button
                        onClick={() => handleDeleteCategory(category.id)}
                        className="w-8 h-8 flex items-center justify-center style={{color: 'var(--danger)'}} hover:bg-red-50 rounded transition-all"
                      >
                        <Trash2 size={16} />
                      </button>
                    </div>
       ...
       {/* 关于 */}
       <div className="bg-white border style={{borderColor: 'var(--border)'}} rounded-[13px] style={{boxShadow: 'var(--shadow)'}} p-8 mt-6">
         <h3 className="text-xl font-extrabold style={{color: 'var(--text)'}} mb-6">关于</h3>
       ...
       {showEncryptExportModal && (
         <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
           <div className="bg-white rounded-lg style={{boxShadow: 'var(--shadow-lg)'}} max-w-md w-full p-6 animate-slide-up">
             ...
             <p className="text-sm style={{color: 'var(--text-muted)'}} mb-4">
      ...
      {showImportModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
          <div className="bg-white rounded-lg style={{boxShadow: 'var(--shadow-lg)'}} max-w-4xl w-full p-6 animate-slide-up max-h-[90vh] overflow-y-auto">
            <h3 className="text-xl font-bold mb-4 style={{color: 'var(--text)'}}">
              导入账单
            </h3>
            ...
            <div className="space-y-4 mb-6">
              ...
              {importPreview.length > 0 && (
                <div>
                  ...
                  <div className="border style={{borderColor: 'var(--border)'}} rounded-lg overflow-hidden max-h-60 overflow-y-auto">
                    <table className="w-full text-sm">
                      <thead className="style={{backgroundColor: 'var(--bg-soft)'}} sticky top-0">
                        <tr>
                          <th className="text-left px-3 py-2 border-b style={{borderColor: 'var(--border)'}} style={{color: 'var(--text-muted)'}}">时间</th>
                          <th className="text-left px-3 py-2 border-b style={{borderColor: 'var(--border)'}} style={{color: 'var(--text-muted)'}}">类型</th>
                          <th className="text-left px-3 py-2 border-b style={{borderColor: 'var(--border)'}} style={{color: 'var(--text-muted)'}}">分类</th>
                          <th className="text-right px-3 py-2 border-b style={{borderColor: 'var(--border)'}} style={{color: 'var(--text-muted)'}}">金额</th>
                          <th className="text-left px-3 py-2 border-b style={{borderColor: 'var(--border)'}} style={{color: 'var(--text-muted)'}}">备注</th>
                        </tr>
                      </thead>
                      <tbody>
                        {importPreview.slice(0, 10).map((transaction, index) => {
                          ...
                          return (
                            <tr key={index} className="border-b style={{borderColor: 'var(--border)'}} hover:style={{backgroundColor: 'var(--bg-soft)'}}">
                              ...
                              <td className="px-3 py-2 style={{color: 'var(--text-muted)'}} truncate max-w-xs">
                                {transaction.remark || '-'}
                              </td>
                            </tr>
                          )
           ...
           <div className="bg-white rounded-lg style={{boxShadow: 'var(--shadow-lg)'}} max-w-md w-full p-6 animate-slide-up">
             ...
             <form onSubmit={handleAddMember} className="space-y-4">
               ...
               <div>
                 ...
                 <p className="text-xs style={{color: 'var(--text-muted)'}} mt-1">管理员角色只能有一个，为默认创建的账户</p>
               </div>
                      ...
                      <label
                        ...
                        className={`flex items-center gap-3 p-3 border rounded-lg cursor-pointer transition-all ${
                          riskAnswers[q.id] === option.score 
                            ...
                            : 'style={{borderColor: 'var(--border)'}} hover:border-blue-200 hover:bg-blue-50/30'
                        }`}
                      >
                        <input
                          type="radio"
                        ...
                        />
                        <span className="style={{color: 'var(--text)'}}">{option.text}</span>
                      </label>
                    ))}
                  </div>
                </div>
