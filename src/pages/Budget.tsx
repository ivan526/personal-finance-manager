...
export default function Budget({ className }: Props) {
 ...
 {/* 头部区域 */}
 <div className="bg-white border rounded-[13px] p-8 mt-8" style={{boxShadow: 'var(--shadow)', borderColor: 'var(--border)'}}>
 ...
 className="px-4 py-2.5 border rounded-sm transition-all font-medium" style={{color: 'var(--text)', backgroundColor: 'var(--bg-soft)', borderColor: 'var(--border)'}}
 >
 取消
 </button>
 <button
 ...
 <div>
 <div className="text-base font-semibold mb-2" style={{color: 'var(--text-muted)'}}>月度总预算</div>
 {isEditing ? (
 <input
 type="number"
 ...
 placeholder="设置总预算"
 className="text-[35px] font-black bg-transparent border-b border-blue-300 focus:outline-none focus:border-blue-600 w-48" style={{color: 'var(--primary)'}}
 />
 ) : (
 <div className="text-[35px] font-black leading-none" style={{color: 'var(--primary)'}}>
 ¥{animatedTotalBudget}
 </div>
 )}
 {/* 结转信息 */}
 ...
 <div className="text-base font-semibold mb-2" style={{color: 'var(--text-muted)'}}>已支出</div>
 <div className="text-[35px] font-black leading-none" style={{color: 'var(--danger)'}}>
 ...
 <span style={{color: 'var(--text)'}}>使用进度</span>
 <span>
 ...
 style={{color: totalUsage >= 100 ? 'var(--danger)' : 'var(--warning)'}}>
 ...
 <h3 className="text-xl font-extrabold mb-6" style={{color: 'var(--text)'}}>分类预算</h3>
 ...
 return (
 <div key={category.id} className="border rounded-[14px] p-5 hover:border-blue-200 transition-all" style={{boxShadow: 'var(--shadow)', borderColor: 'var(--border)'}}>
 ...
 placeholder="0"
 className="w-20 text-right border-b focus:outline-none focus:border-[var(--primary)] bg-transparent font-medium" style={{borderColor: 'var(--border)'}}
 />
 </div>
 ) : (
 ...
 className="w-full mt-3 text-sm hover:text-blue-700 flex items-center justify-center gap-1 font-medium py-2 rounded-sm hover:bg-blue-50 transition-all" style={{color: 'var(--primary)'}}
 >
 <Plus size={16} />
 设置预算
 </button>
 ...
 <h3 className="text-xl font-extrabold mb-6" style={{color: 'var(--text)'}}>近6个月预算趋势</h3>
 <div className="overflow-x-auto">
 <table className="w-full">
 <thead>
 <tr className="border-b" style={{borderColor: 'var(--border)', backgroundColor: 'var(--bg-soft)'}}>
 <th className="text-left px-4 py-3 text-xs font-bold uppercase tracking-wider" style={{color: 'var(--text-muted)'}}>月份</th>
 <th className="text-right px-4 py-3 text-xs font-bold uppercase tracking-wider" style={{color: 'var(--text-muted)'}}>预算金额</th>
 <th className="text-right px-4 py-3 text-xs font-bold uppercase tracking-wider" style={{color: 'var(--text-muted)'}}>实际支出</th>
 <th className="text-right px-4 py-3 text-xs font-bold uppercase tracking-wider" style={{color: 'var(--text-muted)'}}>剩余金额</th>
 <th className="text-right px-4 py-3 text-xs font-bold uppercase tracking-wider" style={{color: 'var(--text-muted)'}}>使用率</th>
 <th className="text-right px-4 py-3 text-xs font-bold uppercase tracking-wider" style={{color: 'var(--text-muted)'}}>状态</th>
 </tr>
 </thead>
 <tbody>
 {historyData.map(item => (
 <tr key={item.month} className="border-b transition-all" style={{backgroundColor: 'var(--bg-soft)', borderColor: 'var(--border)'}}>
